 ...
 * @author yasmi
 */
public class Item_CEAP_GUI extends javax.swing.JFrame {

    /**
     * Creates new form chave_DGV_GUI
     */
    public Item_CEAP_GUI() {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(Item_CEAP_GUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(593, 430, 100, 23);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Item_CEAP_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
